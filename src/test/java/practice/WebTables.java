...
public class WebTables {
    ...
    // Preconditions:
    //1.we navigate to practice wed site
    // 2.click on the Sortable Data Table link

    // Test cases:
    // Verify that row 2 column 4 is $51.00
    // Verify the number of rows is 4 in  table1 body
    ...
    @Test(description = "Verify the number of rows is 4 in table1 body")
    public void testCase2(){
       ...
       int expectedRows = 4;
       Assert.assertEquals(actualRows,expectedRows, "Number of rows don't match");
